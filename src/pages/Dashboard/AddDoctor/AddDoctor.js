...
const AddDoctor = () => {
    ...
    const {data:specialties=[], isLoading } = useQuery({
        queryKey: ["specialty"],
        queryFn: async () => {
            const res = await fetch(`https://doctors-portal-server-kappa-bice.vercel.app/appointmentSpecialty`)
    ...
    const handleAddDoctor = async(data) => {
        ...
        if (imageData.success) {
            ...
            fetch("https://doctors-portal-server-kappa-bice.vercel.app/doctors", {
                method: "POST",
                headers: {
